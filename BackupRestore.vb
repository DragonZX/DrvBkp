...
Namespace DeviceBackupRestore
    ...
    Public Enum BackupRestoreErrorCodes
        ...
        BRE_OEMInfExist 'The � drivers already installed on your computer
        BRE_OEMInfAlreadyUsed 'The drivers � currently in use and can not be uninstalled.
        BRE_MissingInfFile 'The installation file � missing
...
#End Region
    ...
    Public Class DeviceBackup
        ...
        'Propriet� privata thread-safe che regola l'accesso a cancelBackup
        ...
        Public Property BackupPathFormat() As String
            'Inserisce il formato con cui verr� costruito il nome della directory di ciascun device
            Get
        ...
        Public Sub Backup()
            ...
            Try
                ...
                'Controlla se lo spazio su disco � sufficiente
                ...
                For Each dc As Device In Me.bk_devCollection
                    ...
                    Try
                        ...
                        'Informazioni estese non corrette o il device non � selezionato
    ...
    Public Class DeviceRestore
                ...
                For Each dv As Device In devList
                    ...
                    Try 'Gestione errori ripristino
                        ...
                        If File.Exists(infFile) OrElse [String].Compare(Path.GetExtension(infFile), "Inf", True) <> 0 Then
                            ...
                            Else
                                ...
                                If Marshal.GetLastWin32Error = ERROR_FILE_EXISTS Then
                                    If UpdateDeviceInfo Then
                                        'L'utente ha gi� scelto di forzare l'installazione del driver
                        ...
                        Else
                            ...
                            hasErrors = True
                            Continue For 'Il file di installazione non � stato trovato
                        End If
        ...
        'Il driver � stato effettivamente ripristinato da DriverBackup!
                        ...
                        For Each pnpDev As Device In pnpDevsInstalled
                            If [String].Compare(pnpDev.MatchingID, dv.MatchingID) = 0 Then
                                If DateTime.Compare(dv.ReleaseDate, pnpDev.ReleaseDate) > 0 Or dv.ReleaseVersion > pnpDev.ReleaseVersion Then
                                    'Il driver installato sul computer � meno recente di quello contenuto nel package
                                    'di backup
                                    dv.ExtendedInfo.Item("Selected") = True
        ...
        Private Sub New(ByVal list As DeviceCollection, ByVal info As BRPackageInfo, ByVal path As String)
            ...
            CheckDevices() 'Verifica l'utilizzabilit� dei drivers salvati
        End Sub
